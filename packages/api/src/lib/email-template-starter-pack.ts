...
export const EMAIL_SYSTEM_TEMPLATES: SystemEmailTemplateDef[] = [
  ...
  },
  {
    ...
    module: "AUTH",
    name: "Auth — Wachtwoord resetten",
    type: "CUSTOM",
    description: "Eenmalige link om het wachtwoord te wijzigen",
    subject: "Reset je Digitify-wachtwoord",
    layout: "minimal",
    body: [
      "Hallo {{contactName}},",
      "",
      "We ontvingen een aanvraag om je Digitify-wachtwoord opnieuw in te stellen.",
      "",
      "Gebruik deze eenmalige link binnen 30 minuten:",
      "{{resetUrl}}",
      "",
