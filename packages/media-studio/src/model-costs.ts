...
export const MODEL_COST_USD: Record<string, number> = {
  ...
  "grok-imagine-text-to-video": 0.5,
  "grok-imagine-image-to-video": 0.5,
  "kling-v3.0-standard-text-to-video": 0.9,
