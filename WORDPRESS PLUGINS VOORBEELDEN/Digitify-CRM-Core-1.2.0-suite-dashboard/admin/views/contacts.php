...
<div class="owmc-page">
  ...
  <div class="owmc-filter-bar">
    <form method="get" class="owmc-filter-form">
      <input type="hidden" name="page" value="dcrm_contacts">
  ...
  <div class="owmc-pipeline-board">
    <?php foreach ( $pipelineStages as $stage ) :
      $stageItems = array_filter( $items, function( $c ) use ( $stage ) {
        $current = isset( $c->pipeline_stage ) && $c->pipeline_stage ? $c->pipeline_stage : 'Nieuw';
    ...
    <div class="owmc-pipeline-col">
      ...
      <div class="owmc-pipeline-cards">
        ...
        <a href="?page=dcrm_contacts&id=<?php echo (int) $contact->id; ?>" class="owmc-contact-card">
    ...
    <div class="owmc-card-body owmc-table-wrap">
      ...
      <table class="owmc-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="?page=dcrm_contacts&id=<?php echo (int) $contact->id; ?>" class="owmc-action-btn">Bekijken →</a></td>
          </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
      ...
      <div class="owmc-pagination">
        <?php for ( $i = 1; $i <= $pages; $i++ ) :
          $url = add_query_arg( [ 'paged' => $i, 'page' => 'dcrm_contacts' ] );
        ?>
