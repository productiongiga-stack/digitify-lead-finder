...
import { ExpiringDomainsWidget } from "./expiring-domains-widget";
...
const DASHBOARD_QUERY_OPTS = { staleTime: 5 * 60_000, refetchOnMount: false } as const;

type DashboardOverview = RouterOutputs["dashboard"]["getOverview"];
type DashboardReminders = DashboardOverview["reminders"];
...
function ActionCenter({
  ...
  kpis:
    ...
    | undefined;
  reminders: DashboardReminders | undefined;
  loading: boolean;
}) {
...
function ActivityFeed({
  ...
  activities: DashboardOverview["recentActivity"] | undefined;
  isLoading: boolean;
}) {
...
function TopLeads({
  ...
  leads: DashboardOverview["topLeads"] | undefined;
  isLoading: boolean;
}) {
...
function PipelineOverview({
  ...
  stages: DashboardOverview["pipelineOverview"] | undefined;
  isLoading: boolean;
}) {
...
function TasksToday({
  ...
  bookings: DashboardOverview["upcomingBookings"] | undefined;
  isLoading: boolean;
}) {
...
function ActiveChats({
  ...
  chats: DashboardOverview["openChats"] | undefined;
  isLoading: boolean;
}) {
  if (isLoading) {
    return (
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="dashboard-bento">
            <WidgetCard title="Taken vandaag" icon={Bell} className="min-w-0 lg:col-span-4">
              <TasksToday bookings={overview?.upcomingBookings} isLoading={isLoading} />
            </WidgetCard>
            ...
            >
              <LeadFollowUpSnippet reminders={reminders} isLoading={isLoading} />
            </WidgetCard>

            <WidgetCard title="Top leads" icon={TrendingUp} href="/leads" className="min-w-0 lg:col-span-4">
              <TopLeads leads={overview?.topLeads} isLoading={isLoading} />
            </WidgetCard>
          </div>
          ...
          <div className="dashboard-bento">
            <div className="min-w-0 space-y-3 lg:col-span-7">
              ...
              >
                <ActivityFeed activities={overview?.recentActivity} isLoading={isLoading} />
              </WidgetCard>
            </div>

            <div className="min-w-0 space-y-3 lg:col-span-5">
              <WidgetCard title="Pipeline" icon={Target}>
                <PipelineOverview stages={overview?.pipelineOverview} isLoading={isLoading} />
              </WidgetCard>
              <WidgetCard
                ...
                href="/domains"
              >
                <ExpiringDomainsWidget domains={overview?.expiringDomains} isLoading={isLoading} />
              </WidgetCard>
            </div>
          </div>
          ...
          <div className="dashboard-bento">
            ...
            >
              <UpcomingBookings bookings={overview?.upcomingBookings} isLoading={isLoading} />
            </WidgetCard>
            ...
            <WidgetCard
              ...
              className="min-w-0 lg:col-span-6"
            >
              <ActiveChats chats={overview?.openChats} isLoading={isLoading} />
            </WidgetCard>
          </div>
        </TabsContent>
