...
import {
  DEFAULT_PDF_NEXT_STEPS_JSON,
  DEFAULT_PDF_PROCESS_STEPS_JSON,
  DEFAULT_PDF_SERVICES_CARDS_JSON,
  DEFAULT_PDF_TIPS_JSON,
} from "./pdf-defaults";
import { SERVICE_TEMPLATES, type EditableService } from "./quote-service-templates";
...
></iframe>`,
  ...
  async function uploadConfiguratorImage(file: File) {
    if (!file.type.startsWith("image/")) {
      throw new Error("Kies een PNG, JPG of WebP bestand.");
    }
