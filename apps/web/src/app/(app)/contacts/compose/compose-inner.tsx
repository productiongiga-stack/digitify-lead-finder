...
export function ComposeInner() {
  ...
  const { data: leadOptions = [], isLoading: leadsLoading } = trpc.lead.options.useQuery({
  ...
  useEffect(() => {
    if (!selectedLead || effectiveLeadId !== leadIdFromQuery) return;
    setLeadSearch((current) => current || selectedLead.companyName || selectedLead.website || "");
    setToEmail((current) => current || selectedLead.email || "");
  }, [selectedLead, effectiveLeadId, leadIdFromQuery]);
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <EmailPreview
                    ...
                    fromName={senderName || brandCompanyName}
            ...
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0 space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Live preview met workspace mail-opmaak
