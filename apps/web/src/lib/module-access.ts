...
export const ROUTE_MODULE_RULES: Array<{ prefix: string; moduleId: string }> = [
  ...
  { prefix: "/forms", moduleId: "forms" },
  { prefix: "/automations", moduleId: "automations" },
  { prefix: "/files", moduleId: "files" },
  { prefix: "/activity", moduleId: "activityLog" },
  { prefix: "/knowledge", moduleId: "knowledge" },
  { prefix: "/seo", moduleId: "seo" },
