...
export function MediaJobProgress({ status, elapsedSeconds, pollError, onRetry, hint }: Props) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-amber-500/20 bg-gradient-to-r from-amber-500/5 via-background to-violet-500/5">
      <div className="relative flex items-center gap-3 px-4 py-3 text-sm">
        <div className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-amber-500/15">
      ...
      <div className="h-1 w-full overflow-hidden bg-muted">
        <div className="h-full w-2/5 animate-pulse bg-gradient-to-r from-transparent via-amber-500 to-transparent" />
      </div>
    </div>
  );
}
